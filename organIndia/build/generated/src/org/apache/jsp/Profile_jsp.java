...
public final class Profile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                    <li><div class=\"navbar-text\"><p>Welcome: </p></div></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"email\" class=\"control-label\">Name: <font color=\"grey\"></font></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div><!--end form group-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"name\" class=\"control-label\">Email:<font color=\"grey\"></font></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div><!--end form group-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"gender\" class=\"control-label\">Gender: <font color=\"grey\"></font></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div><!--end form group-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"dob\" class=\"control-label\">Date of Birth: <font color=\"grey\"></font></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div><!--end form group-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-lg-10 form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"state\" class=\"control-label\">Address: <font color=\"grey\"></font></label>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div><!--end form group-->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-10 form-group\">\r\n");
