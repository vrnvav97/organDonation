        ...
        <div class="grid-overlay">
          <div class="overlay-content-wrapper">
            ...
            <div class="overlay-label">
              Get to know Information about your Hospital
            </div>
          </div>
      ...
      <div class="grid">
        ...
        <div class="grid-overlay">
          <div class="overlay-content-wrapper">
            ...
            <div class="overlay-label">
              Know Data about different Departments in your hospital
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid">
        ...
        <div class="grid-overlay">
          <div class="overlay-content-wrapper">
            ...
            <div class="overlay-label">
              View and Enter Data about Beds in your hospital
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="grid">
        ...
        <div class="grid-overlay">
          <div class="overlay-content-wrapper">
            ...
            <div class="overlay-label">
              Keep Hospital Profile Upto Date
            </div>
          </div>
        </div>
      </div>
