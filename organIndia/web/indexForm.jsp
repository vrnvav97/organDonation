	...
	<body>
		<div class="container">
			<section class="content bgcolor-1">
				<h2 class="nomargin-bottom">Name</h2>
			...
			<section class="content bgcolor-7">
				...
				<span class="input input--jiro">
					...
					<label class="input__label input__label--jiro" for="input-11">
						<span class="input__label-content input__label-content--jiro">Gender</span>
					</label>
				</span>
				<span class="input input--jiro">
			...
			<section class="content bgcolor-5">
				<h2>Person Incharge</h2>
				<span class="input input--minoru">
					<input class="input__field input__field--yoko" type="text" id="input-16" />
					<label class="input__label input__label--yoko" for="input-16">
						<span class="input__label-content input__label-content--yoko">Person Name</span>
					</label>
				</span>
				<span class="input input--minoru">
				...
				<span class="input input--minoru">
					...
					<label class="input__label input__label--yoko" for="input-18">
						<span class="input__label-content input__label-content--yoko">Relation</span>
					</label>
				</span>
			</section>
			<section class="content">
